...
export const TRANSLATIONS = {
  [Language.EN]: {
    ...
    // Lab Tests / Stats Admin
    summary: 'Summary',
    labsManagement: 'Lab Tests',
    addNewLab: 'Add New Test',
    duration: 'Duration',
    preparation: 'Preparation Instructions',
    noLabsYet: 'No lab tests added yet.',
    ...
    coachPasswordNote: 'Note: password cannot be reset after creation; coach can reset via support if needed.',
    bookTest: 'Book Test',
    labsTitle: 'Lab Tests',
    labsSubtitle: 'Book a test from our trusted partners.',
    chatWithCoach: 'Chat with Coach',
    coachInbox: 'Coach Inbox',
    selectAConversation: 'Select a conversation to start replying.',
  ...
  [Language.AR]: {
    ...
    // Lab Tests / Stats Admin
    summary: 'وصف مختصر',
    labsManagement: 'الفحوصات المخبرية',
    addNewLab: 'إضافة فحص جديد',
    duration: 'مدة النتيجة',
    preparation: 'تعليمات التحضير',
    noLabsYet: 'لم تتم إضافة فحوصات بعد.',
    ...
    coachPasswordNote: 'ملاحظة: لا يمكن إعادة تعيين كلمة المرور بعد إنشاء الحساب. يمكن للخبير التواصل مع الدعم لإعادة الضبط.',
    bookTest: 'احجز الفحص',
    labsTitle: 'الفحوصات المخبرية',
    labsSubtitle: 'احجز فحصك من شركائنا الموثوقين.',
    chatWithCoach: 'تواصل مع الخبير',
    coachInbox: 'صندوق الخبير',
    selectAConversation: 'اختر محادثة لبدء الرد.',
    typeYourReply: 'اكتب ردك...',
    noConversationsYet: 'لا توجد محادثات بعد.',
    welcomeCoach: 'أهلاً بك أيها الخبير',
